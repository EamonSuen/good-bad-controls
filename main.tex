...
\usepackage[
  backend=biber,
  style=apa, %apa风格，适合社会科学
]{biblatex}
\addbibresource{references.bib}

\setbeamertemplate{frametitle continuation}{(\insertcontinuationcount)} % 显示分页为阿拉伯数字(1), (2)
...
\input{sections/02_传统范式}
\input{sections/03_基于设计的研究范式}
\input{sections/04_Simpson's Paradox}
\input{sections/05_good-bad control}
